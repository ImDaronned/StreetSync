...
class _CreateServicePage extends State<CreateServicePage> {
  ...
  void _sendData() async {
    ...
    const String tokenName = 'martin';
    const String token =
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoiMTcxNTM3NTU0NzUxNSIsImlhdCI6MTcxNTM3NTU5NSwiZXhwIjoxNzE1NDYxOTk1fQ.anLaA_LAg4mGcIO-pJzg6VWy4hd4kYJMO99H8UQ7kZs';

    final response = await http.post(
      Uri.parse(ApiEndpoints.endPoints.createService),
