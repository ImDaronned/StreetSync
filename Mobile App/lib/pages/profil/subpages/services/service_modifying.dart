...
class ModifyMySercice extends StatefulWidget {
  final Services service;

  const ModifyMySercice({super.key, required this.service});

  @override
  State<ModifyMySercice> createState() => _ModifyMySerciceState();
}

class _ModifyMySerciceState extends State<ModifyMySercice> {
  ...
  void _sendData() async {
    ...
    if (name.isNotEmpty) {
      ...
      jsonData["price"] = double.parse(price);
    } if (tags.isNotEmpty) {
      jsonData["tags"] = tags;
    ...
    final response = await http.patch(
      Uri.parse('${ApiEndpoints.endPoints.services}?id=${widget.service.id}'),
